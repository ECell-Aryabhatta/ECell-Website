...
function EcellAryabhatta_customize_register( $wp_customize ) {

    //Style Preset
    $wp_customize->add_section(
        'typography',
        array(
            'title' => __( 'Preset Styles', 'EcellAryabhatta' ),
            //'description' => __( 'This is a section for the typography', 'EcellAryabhatta' ),
            'priority' => 20,
        )
    );
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'theme_option_setting', array(
        'label' => __( 'Theme Option', 'EcellAryabhatta' ),
        'section'    => 'typography',
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'preset_style_setting', array(
        'label' => __( 'Typography', 'EcellAryabhatta' ),
        'section'    => 'typography',
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'preset_color_scheme_setting', array(
        'label' => __( 'Color Scheme', 'EcellAryabhatta' ),
        'section'    => 'typography',
    ...
    $wp_customize->add_section(
        'header_image',
        array(
            'title' => __( 'Header Banner', 'EcellAryabhatta' ),
            'priority' => 30,
        )
    );
    ...
    $wp_customize->add_control(
        'header_img',
        array(
            'label' => __( 'Header Image', 'EcellAryabhatta' ),
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'header_bg_color',
            array(
                'label'      => __( 'Header Banner Background Color', 'EcellAryabhatta' ),
    ...
    $wp_customize->add_setting( 'header_banner_tagline_setting', array(
        'default' => __( 'To customize the contents of this header banner and other elements of your site go to Dashboard - Appearance - Customize','EcellAryabhatta' ),
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_banner_tagline_setting', array(
        'label' => __( 'Banner Tagline', 'EcellAryabhatta' ),
        'section'    => 'header_image',
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_banner_visibility', array(
        ...
        'label'    => __('Remove Header Banner', 'EcellAryabhatta'),
        'section'    => 'header_image',
        'type'     => 'checkbox',
    ) ) );
   ...
   $wp_customize->add_section(
        ...
        array(
            'title' => __( 'Other Customizations', 'EcellAryabhatta' ),
            //'description' => __( 'This is a section for the header banner Image.', 'EcellAryabhatta' ),
            'priority' => 40,
        )
    );
    $wp_customize->add_section(
        'colors',
        array(
            'title' => __( 'Background Color', 'EcellAryabhatta' ),
            //'description' => __( 'This is a section for the header banner Image.', 'EcellAryabhatta' ),
            'priority' => 50,
    ...
    $wp_customize->add_section(
        'background_image',
        array(
            'title' => __( 'Background Image', 'EcellAryabhatta' ),
            //'description' => __( 'This is a section for the header banner Image.', 'EcellAryabhatta' ),
            'priority' => 60,
            'panel' => 'styling_option_panel',
        )
    ...
    $wp_customize->add_setting( 'cdn_assets_setting', array(
        'default' => __( 'no','EcellAryabhatta' ),
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );
    $wp_customize->add_control( 
        'cdn_assets',
        array(
            'label' => __( 'Use CDN for Assets', 'EcellAryabhatta' ),
            'description' => __( 'All Bootstrap Assets and FontAwesome will be loaded in CDN.', 'EcellAryabhatta' ),
            'section' => 'site_name_text_color',
            'settings' => 'cdn_assets_setting',
	        'type'    => 'select',
	        'choices' => array(
	            'yes' => __( 'Yes', 'EcellAryabhatta' ),
	            'no' => __( 'No', 'EcellAryabhatta' ),
        	)
        )
    );
    ...
    $wp_customize->add_setting( 'EcellAryabhatta_logo', array(
        //'default' => __( '', 'EcellAryabhatta' ),
        'sanitize_callback' => 'esc_url',
    ) );
    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'EcellAryabhatta_logo', array(
        'label'    => __( 'Upload Logo (replaces text)', 'EcellAryabhatta' ),
        'section'  => 'title_tagline',
        'settings' => 'EcellAryabhatta_logo',
    ) ) );

}
add_action( 'customize_register', 'EcellAryabhatta_customize_register' );

add_action( 'wp_head', 'EcellAryabhatta_customizer_css');
function EcellAryabhatta_customizer_css()
{
    ?>
    <style type="text/css">
 ...
 */
function EcellAryabhatta_customize_preview_js() {
    wp_enqueue_script( 'EcellAryabhatta_customizer', get_template_directory_uri() . '/inc/assets/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'EcellAryabhatta_customize_preview_js' );
